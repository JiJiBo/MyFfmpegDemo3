...
/**
 * Allocate an AVMurMur3 hash pFormatCtx.
 *
 * @return Uninitialized hash pFormatCtx or `NULL` in case of error
 */
struct AVMurMur3 *av_murmur3_alloc(void);

/**
 * Initialize or reinitialize an AVMurMur3 hash pFormatCtx with a seed.
 *
 * @param[out] c    Hash pFormatCtx
...
/**
 * Initialize or reinitialize an AVMurMur3 hash pFormatCtx.
 *
...
/**
 * Update hash pFormatCtx with new data.
 *
 * @param[out] c    Hash pFormatCtx
 ...
 *
 * @param[in,out] c    Hash pFormatCtx
