 ...
 *
 * @note Using a different pFormatCtx than the one allocated during av_tx_init()
 * is not allowed.
 *
 * @param s the transform pFormatCtx
...
/**
 * Initialize a transform pFormatCtx with the given configuration
 ...
 *
 * @param ctx the pFormatCtx to allocate, will be NULL on error
...
/**
 * Frees a pFormatCtx and sets ctx to NULL, does nothing when ctx == NULL
 */
