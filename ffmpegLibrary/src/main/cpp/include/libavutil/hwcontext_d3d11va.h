...
typedef struct AVD3D11VADeviceContext {
     ...
     * device pFormatCtx fields are set from this and are available for convenience.
     *
...
typedef struct AVD3D11VAFramesContext {
     ...
     * at least set D3D11_BIND_DECODER if the frames pFormatCtx is to be used for
     * video decoding.
